...
import (
	...
	versioned "github.com/boknowswiki/boknows_services/bookstore-controller/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/boknowswiki/boknows_services/bookstore-controller/pkg/generated/informers/externalversions/internalinterfaces"
	v1 "github.com/boknowswiki/boknows_services/bookstore-controller/pkg/generated/listers/bookcontroller/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.BookcontrollerV1().Books(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.BookcontrollerV1().Books(namespace).Watch(context.TODO(), options)
			},
		},
		&bookcontrollerv1.Book{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *bookInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&bookcontrollerv1.Book{}, f.defaultInformer)
}
